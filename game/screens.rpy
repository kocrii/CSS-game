...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Inizio") action Start()

        else:

            textbutton _("Storia") action ShowMenu("history")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Audio")
                    textbutton _("Voci Personaggi") action ToggleVariable("persistent.voice_enabled", True, False)
